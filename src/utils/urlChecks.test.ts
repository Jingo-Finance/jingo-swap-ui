...
test('hasURL', () => {
  expect(hasURL('this is my personal website: https://www.jingo.finance')).toBe(true)
  expect(hasURL('#corngang')).toBe(false)
  expect(hasURL('Unislap-LP.org')).toBe(true)
  expect(hasURL('https://jingo.finance')).toBe(true)
  expect(hasURL('https://jingo.finance')).toBe(true)
  expect(hasURL('http://jingo.finance')).toBe(true)
